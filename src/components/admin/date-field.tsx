 ...
 */
const DateFieldImpl = <RecordType extends Record<string, unknown> = Record<string, unknown>>(
...
export interface DateFieldProps<RecordType extends Record<string, unknown> = Record<string, unknown>>
