...
import { type SupportCreateSuggestionOptions, useSupportCreateSuggestion } from "@/hooks/useSupportCreateSuggestion";
...
export const AutocompleteInput = (
    ...
    const handleChange = useCallback(
        ...
        [field.value, field.onChange, getChoiceValue, isRequired, isFromReference, setFilters, filterToQuery],
    );
