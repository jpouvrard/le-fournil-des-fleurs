...
export const AutocompleteArrayInput = (
    props: Omit<InputProps, "source"> &
        ...
        ChoicesProps & {
            ...
            placeholder?: string;
            inputText?: React.ReactNode | ((option: unknown | undefined) => React.ReactNode);
        },
) => {
    ...
    return (
        <FormField className={props.className} id={id} name={field.name}>
            ...
            <FormControl>
                ...
                >
                    <div className="group rounded-md border border-input bg-transparent px-3 py-1.75 text-sm ring-offset-background transition-all focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50 dark:bg-input/30">
