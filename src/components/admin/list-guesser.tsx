...
import { type ListProps, ListView, type ListViewProps } from "@/components/admin/list";
...
const listFieldTypes = {
    table: {
        ...
        representation: (_props: Record<string, unknown>, children: { getRepresentation: () => string }[]) =>
            `        <DataTable>
${children.map((child) => `            ${child.getRepresentation()}`).join("\n")}
    ...
    reference: {
        component: (props: Record<string, unknown>) => (
            <DataTable.Col source={props.source as string}>
    ...
    string: {
        ...
        representation: (props: Record<string, unknown>) => `<DataTable.Col source="${props.source}" />`,
    },
};
