...
export const RecordField = <RecordType extends Record<string, unknown> = Record<string, unknown>>(
...
export interface RecordFieldProps<RecordType extends Record<string, unknown> = Record<string, unknown>>
