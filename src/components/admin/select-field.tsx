 ...
 */
const SelectFieldImpl = <RecordType extends Record<string, unknown> = Record<string, unknown>>(
    ...
    const choice = choices ? choices.find((choice: unknown) => getChoiceValue(choice) === value) : null;
...
export interface SelectFieldProps<RecordType extends Record<string, unknown> = Record<string, unknown>>
