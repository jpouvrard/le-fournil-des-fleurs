...
import { Translate, useDefaultTitle, useResetErrorBoundaryOnLocationChange } from "ra-core";
import type { HtmlHTMLAttributes } from "react";
import type { ErrorInfo } from "react";

export const ErrorPage = (props: InternalErrorProps & {}) => {
        ...
        <>
            ...
            <div className="flex flex-col items-center gap-5 p-20" {...rest}>
                <h1 className="mt-5 mb-5 flex items-center gap-3 text-3xl" role="alert">
                    <CircleAlert className="h-2em w-2em" />
                ...
                {process.env.NODE_ENV !== "production" && (
                    <>
                        <Accordion type="multiple" className="mt-1 w-150 bg-secondary p-2">
