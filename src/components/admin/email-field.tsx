...
const EmailFieldImpl = <RecordType extends Record<string, unknown> = Record<string, unknown>>(
...
export interface EmailFieldProps<RecordType extends Record<string, unknown> = Record<string, unknown>>
